...
def parse_args():
    ...
    # gated layer
    parser.add_argument("--gated-num-layers", type=int, default=4)
    parser.add_argument("--gated-hidden-size", type=int, nargs="+", default=[400, 400, 400, 400])
    ...
    parser.add_argument("--gated-dropout", type=float, default="0.1")
    ...
    parser.add_argument("--fc-hidden-size", type=int, nargs="+", default=[1400, 1400, 1400, 1400])
...
def grapher(dielectric_constant=None, mol_volume=False):
    ...
    global_featurizer = SolventGlobalFeaturizer(dielectric_constant=dielectric_constant, mol_volume=mol_volume)
